...
q1= model_loaded.docvecs["sent_5"]
...
myfile = open("/home/raksha/FIRE-2016/CHIS_TrainingData/q04.txt", "w")  #write sentences in text file
model_loaded = models.Doc2Vec.load('/home/raksha/FIRE-2016/q04_sentences.doc2vec') #load doc to vec repr of sentences
book = xlrd.open_workbook(path)
first_sheet = book.sheet_by_index(0)

output_file = open("/home/raksha/FIRE-2016/CHIS_TrainingData/q4_op.txt", "w") #write relevant/irrelevant class

output_file2 = open("/home/raksha/FIRE-2016/CHIS_TrainingData/q4_t2_op.txt", "w") # write support(1),oppose(-1),neutral(0)
deep_list =[]
...
#------------------------------------------------------------------------------------------------------------
path = "/home/raksha/FIRE-2016/CHIS_testSet/final_fire_test_data_xls/vitaminC.xlsx" #load test data    
book = xlrd.open_workbook(path)
...
#q1= sentences[1]
myfile = open("/home/raksha/FIRE-2016/CHIS_TrainingData/q04.txt", "r") #open file containing both training and testing sentences 
tags = myfile.readlines()

for i in range(len(tags)):
 tags[i] = str(q1) + tags[i] #query,sentence pair

with open("/home/raksha/FIRE-2016/CHIS_TrainingData/q4_op.txt") as input: #load output for training in task 1
...
model_loaded = models.Doc2Vec.load('q04_test.doc2vec')
deep_list2 = []
...
with open("/home/raksha/FIRE-2016/CHIS_TrainingData/q4_t2_op.txt") as input:
...
from xlrd import *
w = copy(open_workbook('/home/raksha/FIRE-2016/CHIS_testSet/final_fire_test_data_xls/vitaminC.xlsx'))

for i in range(len(predict1)):
  w.get_sheet(0).write(i+1,1,predict1[i])
  w.get_sheet(0).write(i+1,2,polar[i])   

w.save('/home/raksha/FIRE-2016/CHIS_testSet/final_fire_test_data_xls/vitaminC.xlsx')
print "Done"
